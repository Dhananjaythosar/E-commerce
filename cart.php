...
{
    $q=" insert into cart (pid, product_name,product_price, product_img, qty,total_price, product_code) VALUES ('$pid','$pname','$pprice','$pimage','1','$pprice','$pcode' )";
                ...
                <table>
                    <tr>
                       <th></th>
                        ...
                        <th>Quantity</th>
                        <th>total price</th>
                        <th><a href="cart.php?clear=all "class="fa fa-trash" onclike="return">&nbsp; clear cart</a></th>
                        <th></th>
                    ...
                    <tbody>
                         ...
                         ?>
                           <tr>
                                ...
                                <td><a href="delete_cart.php?pcode=<?=$row['product_code']?>"><button  style ='color: red '>Remove</button></a></td>
                                <td></td>
